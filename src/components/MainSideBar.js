      ...
      <nav className={styles.navbar}>
        <ul className={styles["navbar-nav"]}>
          <li className={styles["nav-item"]}>
            <div className={styles["nav-link"]} onClick={() => toggleSideBar(1)}>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
          ...
          <li className={styles["nav-item"]}>
            <div className={styles["nav-link"]} onClick={() => toggleSideBar(2)}>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
          ...
          <li className={styles["nav-item"]}>
            <div className={styles["nav-link"]} onClick={() => toggleSideBar(3)}>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
          ...
          <li className={styles["nav-item"]}>
            <div className={styles["nav-link"]} onClick={() => toggleSideBar(4)}>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fad"
